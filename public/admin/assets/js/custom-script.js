    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.querySelectorAll('.generate-invoice').forEach(button => {
            button.addEventListener('click', function () {
                ...
                const totalPrice = parseFloat(booking.price) || 0; // total including GST
                const basePrice = totalPrice / 1.10; // extract base price
                const gst = totalPrice - basePrice;   // GST portion
